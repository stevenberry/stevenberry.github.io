(() => {
    ...
    if (screen.width > 650) {
        ...
        video1.innerHTML = '<source id="bg-vid1-src" src="https://cdn.elken.io/site/bg/bg1.mp4" type="video/mp4">'
        video2.innerHTML = '<source id="bg-vid2-src" src="https://cdn.elken.io/site/bg/bg2.mp4" type="video/mp4">'
